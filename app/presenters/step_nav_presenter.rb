...
private
  ...
  def edition_links
    ...
    links[:pages_relevant_to_step_nav] = relevant_to_step_nav_links if relevant_to_step_nav_links.present?
    links
  end
  ...
  def relevant_to_step_nav_links
    SecondaryContent.new(step_nav).content_ids
  end
