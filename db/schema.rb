...
ActiveRecord::Schema.define(version: 2018_08_29_151726) do

  create_table "change_notes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "author"
    t.text "description"
    t.bigint "step_by_step_page_id"
    t.datetime "create_at"
    t.index ["step_by_step_page_id"], name: "index_change_notes_on_step_by_step_page_id"
  end
  ...
  add_foreign_key "change_notes", "step_by_step_pages"
