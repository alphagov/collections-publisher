...
RSpec.describe Coronavirus::TimelineEntry do
  ...
  describe "position" do
    ...
    it "should default to position 1 if it is the first timeline entry to have been added" do
      ...
      timeline_entry = create(:timeline_entry, page: coronavirus_page)
    ...
    it "if more timeline entries are added, the previous entries will increment position by 1" do
      ...
      first_timeline_entry = create(:timeline_entry, page: coronavirus_page, heading: "one")
      expect(first_timeline_entry.reload.position).to eq 1

      second_timeline_entry = create(:timeline_entry, page: coronavirus_page, heading: "two")
    ...
    it "should update timeline entry positions when a timeline entry is deleted" do
      original_timeline_entry_one = create(:timeline_entry, page: coronavirus_page)
      original_timeline_entry_two = create(:timeline_entry, page: coronavirus_page)
