...
RSpec.describe "Curating the contents of topics" do
  ...
  context "with a subtopic which has had content curated" do
    before :each do
      ...
      oil_rigs = create(:list, :topic => offshore, :sector_id => 'oil-and-gas/offshore', :name => 'Oil rigs', :index => 0)
      piping = create(:list, :topic => offshore, :sector_id => 'oil-and-gas/offshore', :name => 'Piping', :index => 1)
